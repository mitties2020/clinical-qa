        ...
        try {
          ...
          if (payload?.clinical_data && !payload.clinical_data.includes("AI documentation quality instructions")) {
            ...
            payload.clinical_data = [
              ...
              "- For WA mental health discharge summary, synthesize multiple pasted admission notes into one coherent, polished, comprehensive WA hospital psychiatry discharge summary using NACS-style headings. Write in a senior psychiatry registrar/consultant tone, de-duplicate repeated material, reconcile chronology, preserve uncertainty/collateral limits, clearly separate admission risk from discharge risk, and do not force brevity when detail improves continuity of care. If the patient died during admission, adapt discharge mental state, risk, advice, and follow-up language accordingly.",
              "- For ED MH Review, write an ED psychiatry review progress note using the supplied structured headings. Preserve patient versus collateral attribution, current versus historical timing, uncertainty, exact Mental Health Act form/expiry details, and the link between current risks and management. Do not invent normal MSE findings, risk denials, legal status, diagnoses, medication changes, leave or follow-up.",
              "- For Premature Ejaculation and Erectile Dysfunction, use the Menova ED/PE assessment style: determine ED, PE, combined ED+PE, or unclear; document onset/duration/severity, libido, prior treatments, psychosexual contributors, cardiovascular/metabolic risks, medication interactions and contraindications; only include ED/PE medicines when safe and supported, otherwise state treatment deferred/not indicated and why.",
