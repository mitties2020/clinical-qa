        ...
        try {
          ...
          if (payload?.clinical_data && !payload.clinical_data.includes("AI documentation quality instructions")) {
            ...
            payload.clinical_data = [
              ...
              "- For WA mental health discharge summary, synthesize multiple pasted admission notes into one coherent WA hospital psychiatry discharge summary using NACS-style headings, de-duplicating repeated material, reconciling chronology, preserving uncertainty/collateral limits, and clearly separating admission risk from discharge risk.",
