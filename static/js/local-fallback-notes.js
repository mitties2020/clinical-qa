(function () {
  ...
  function waMentalHealthDischargeSummary(raw) {
    return [
      "Event",
      "WA mental health discharge summary.",
      "",
      "Problems this Admission",
      "Principal psychiatric problem: Not documented",
      "Comorbidities / complications: Not documented",
      "",
      ...
      "",
      "Clinical Synopsis",
      "Multiple pasted admission notes require synthesis. Source material:",
      raw || "Not documented",
      "",
      "Presenting History",
      "Not documented",
      ...
      "Suicide/self-harm risk: Not documented",
      "Risk to others: Not documented",
      "Vulnerability / self-neglect / absconding / substance-related risk: Not documented",
      "",
      ...
      "Current risk formulation: Not documented",
      "Protective factors: Not documented",
      "Risk mitigation / safety plan: Not documented",
      "",
      "Diagnosis",
      "Not documented",
      "",
      ...
      "AI request failed, so this fallback has not synthesized the admission notes. Verify diagnosis, MHA status, discharge MSE, discharge risk formulation, medications, adverse reactions, follow-up, and advice before signing."
    ].join("\n");
  }
  ...
  window.buildLocalFallbackNote = function buildLocalFallbackNote(type, raw) {
    ...
    if (lower === "wa mental health discharge summary") {
      return waMentalHealthDischargeSummary(raw);
    }

    if (lower === "premature ejaculation and erectile dysfunction") {
      return [
        "ED / PE Assessment",
        "Mode: Telehealth",
        "",
        ...
        "",
        "Consent",
        "Phone consult consent: Not documented",
        "Off-label compounded medication consent: Not documented",
        "",
        "Presenting Concern",
        "Patient seeking assessment for erectile dysfunction and/or premature ejaculation.",
        "",
        "History",
        raw,
        "",
        ...
        "Cardiovascular risk, nitrate/nicorandil/poppers use, blood pressure, priapism risk, penile deformity, anticoagulation/bleeding risk, mental health/serotonergic medicine interactions, current medicines, allergies, and My Health Record/medication check require clinician confirmation if not documented.",
        "",
        "Impression",
        "ED / PE assessment completed. Predominant condition and contributing factors require clinician confirmation from the supplied history.",
        "",
        "Plan",
        "Treatment decision: Not documented.",
        "If contraindications, safety concerns, or missing key safety information are present, treatment should be deferred pending clinician/CMO review.",
        "Case manager welcome call and follow-up: Not documented.",
        "",
        "Counselling / Consent",
        "Adverse effects, off-label status, medication instructions, and patient consent: Not documented.",
        "",
        "Critical information missing / issues to address",
        "Confirm ID/consent, ED versus PE versus combined presentation, duration/onset/severity, libido, prior treatment response, PMHx, medications/allergies, cardiovascular suitability, contraindications, and exact medication plan before signing."
      ].join("\n");
    }
